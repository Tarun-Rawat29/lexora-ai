                ...
                <div className="flex
                 flex-col items-center justify-center space-y-4 text-center">
                    <div className="space-y-3">
                        <h2 className="font-bold text-2xl tracking-tighter sm:text-4xl md:text-5xl">
                            Ready to Save Hours of Reading Time?
                        </h2>
                        <p className="mx-auto max-w-[700px] text-sm text-gray-500 md:text-base/relaxed lg:text-base/relaxed xl:text-lg/relaxed dark:text-gray-400">
