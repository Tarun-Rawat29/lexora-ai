...
export default function HowItWorksSectio()
{
    return (
            ...
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <MotionH2
                        ...
                        className="text-lg font-bold uppercase mb-4 text-rose-500"
                    >
                        How it works
                    </MotionH2>
                    <MotionH3
                        ...
                        >
                            ...
                            {idx < steps.length - 1 && (
                                <MotionDiv
                                    ...
                                    transition={{ duration: 0.5, delay: idx * 0.2 + 0.3 }} className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-1/2 z-10"
                                >
                                    <MoveRight 
                                        size={32} 
                                        strokeWidth={1} 
