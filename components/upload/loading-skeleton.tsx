...
export default function LoadingSkeleton() {
    return (
        <Card className="relative px-2 h-[600px] w-[550px] max-w-lg mx-auto overflow-hidden bg-linear-to-br from-background via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-xs border-b border-rose-500/10">
